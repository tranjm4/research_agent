...
class PlannerModel(ModelWrapper):
  def __init__(self, system_prompt: str, version_name: str, model: str = "llama3.2:1b", **kwargs):
    """
...
def default_planner_prompt() -> str:
  ...
  Example output:
  [
    {{"tool": "decompose", "args": {{"input": "What is the history of quantum computing, and how does it relate to modern research in the field?"}}}},
